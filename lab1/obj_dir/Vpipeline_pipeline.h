...
class alignas(VL_CACHE_LINE_BYTES) Vpipeline_pipeline final : public VerilatedModule {
  public:
    ...
    CData/*2:0*/ my_DE_stage__DOT____Vxrand_h8df70ee3__0;
    CData/*3:0*/ my_DE_stage__DOT____Vxrand_h8df6f9e8__0;
    ...
    VlWide<4>/*102:0*/ __PVT__my_AGEX_stage__DOT__de_latch_rest;
